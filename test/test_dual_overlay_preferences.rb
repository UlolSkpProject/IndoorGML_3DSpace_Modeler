    ...
    module IndoorCore
      class DualOverlayPreferencesTest < Minitest::Test
        ...
        def test_state_radius_scale_clamps_to_min_and_max
          key = [UserPreferences::SECTION, DualOverlayPreferences::STATE_SCALE_KEY]

          Sketchup.test_defaults[key] = 0.1
          assert_equal 0.1, DualOverlayPreferences.state_radius_scale
