...
# Standalone policy contract for source-space triangulation collapse handling.
    ...
    module IndoorCore
      class LocalVertexNormalizer
        ...
        def discard_collapsed_triangle_records(
          ...
          raise 'natural-collapse contract expects source coordinates' unless
...
require_relative '../indoor3d/application/local_vertex_normalizer/source_collapsed_sliver_cleanup'
...
puts 'LocalVertexNormalizer natural collapse contract: OK'
