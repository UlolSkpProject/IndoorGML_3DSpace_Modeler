...
module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      class CellSpaceLocalGridCoordinateTest < Minitest::Test
        ...
        def test_context_keeps_scene_order_with_coordinate_preparer
          calls = []
        ...
        def test_grid_snap_uses_millimeter_tolerance
          host = Object.new
          host.extend(IndoorModel::LocalGridCoordinate)

          source_mm = 123.45637
          source_inch = source_mm / IndoorModel::LocalGridCoordinate::LOCAL_GRID_MM_PER_INCH
          snapped_inch = host.send(
            :snap_local_grid_value_inch,
            source_inch,
            0.001
          )
          snapped_mm = snapped_inch * IndoorModel::LocalGridCoordinate::LOCAL_GRID_MM_PER_INCH
        ...
        def test_grid_snapped_recenter_translation_preserves_grid_membership
          ...
          vertex_mm = 1000.001
          center_mm = 123.45637
          center_inch = center_mm / IndoorModel::LocalGridCoordinate::LOCAL_GRID_MM_PER_INCH
          snapped_center_mm = host.send(
            :snap_local_grid_value_inch,
            center_inch,
            0.001
          ) * IndoorModel::LocalGridCoordinate::LOCAL_GRID_MM_PER_INCH
        ...
        def build_context(overrides = {})
          ...
          CellSpaceLifecycleLocalGridContext.new(**callbacks)
        end
      end
    end
  end
