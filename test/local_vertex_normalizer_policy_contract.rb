...
# Standalone policy contract. This does not require SketchUp and verifies the
# two invariants that caused the policy review regressions:
...
require_relative '../indoor3d/application/local_vertex_normalizer/axis_and_triangle_policy'
require_relative '../indoor3d/application/local_vertex_normalizer/rebuild_repair'
...
puts 'LocalVertexNormalizer policy contract: OK'
