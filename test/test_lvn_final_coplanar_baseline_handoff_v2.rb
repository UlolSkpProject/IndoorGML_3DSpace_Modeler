...
module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizerFinalCoplanarBaselineHandoffV2Test < Minitest::Test
        class FakeEntity
        ...
        class ProbeNormalizer
          ...
          def normalize_entity(entity)
            ...
            when :fast
              try_normalized_input_fast_path_v2(entity)
            when :raise
              raise 'inner failure'
            end
        ...
        def test_final_fallback_snapshot_is_also_reused
          ...
          assert_equal 0, subject.fallback_calls
          assert report.dig(:final_coplanar_baseline_handoff_v2, :reused)
          assert_equal :final_fallback,
                       report.dig(:final_coplanar_baseline_handoff_v2, :role)
        end
