...
#
# This is a single-pass launcher built directly from the base runner. It avoids
# patching earlier compatibility launchers. Before dependency loading it:
# - requires a non-empty corpus selection;
# - resolves the production implementation below prepended profiler wrappers;
# - preloads the face-detail probe with only its standalone BASE.run disabled;
# - installs and verifies the incremental coplanar implementation below the
#   common profiler wrapper.
