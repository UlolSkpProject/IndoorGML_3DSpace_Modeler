...
require_relative 'interior_loop_cap'
          ...
          class RebuildAnalyzer
            ...
            def conforming_triangle_soup(triangles)
              ...
              @boundary_ear_repair_report = {
                ...
                'boundary_ear_repair_error' => "#{e.class}: #{e.message}"
              }
              original || triangles
            end
            ...
            def boundary_ear_subdivide_triangle(triangle, candidate_vertices)
              ...
              return nil unless boundary_ear_area_preserved?(triangle, output)
