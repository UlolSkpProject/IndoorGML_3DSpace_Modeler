...
require_relative '../application/indoor_model/cell_space_type_change_optimization'
require_relative '../application/progress/cell_space_mutation_progress_integration'
