...
module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      class IndoorModel
        # Local Grid runtime refresh policy.
        #
        # Hard refresh:
        ...
        def refresh_runtime_data(initial_model_load: false)
          if initial_model_load
            ...
            result = hard_refresh_runtime_data_local_grid(initial_model_load: true)
            return result
          end

          return soft_refresh_runtime_data_local_grid if local_grid_coordinate_enabled?

          super
        end

        # Compatibility entrypoint. Initial load means hard refresh; every other
        # generic refresh means soft refresh.
        def refresh_runtime_data_local_grid(initial_model_load: false)
          enable_local_grid_coordinate!

          return hard_refresh_runtime_data_local_grid(initial_model_load: true) if initial_model_load

          soft_refresh_runtime_data_local_grid
        end

        def hard_refresh_runtime_data_local_grid(initial_model_load: false)
          enable_local_grid_coordinate!

          with_indoor_model_operation('IndoorGML Hard Refresh Runtime Data Local Grid', transparent: true) do
            ...
            with_guard_flag(:@refreshing_runtime) do
              ...
              IndoorCore::Logger.puts(
                '[IndoorGML] Runtime hard-refreshed Local Grid: ' \
        ...
        def soft_refresh_runtime_data_local_grid
          ...
          with_indoor_model_operation('IndoorGML Soft Refresh Runtime Data Local Grid', transparent: true) do
            next true if guard_active?(:@refreshing_runtime)
            ...
            with_guard_flag(:@refreshing_runtime) do
              ...
              IndoorCore::Logger.puts(
                '[IndoorGML] Runtime soft-refreshed Local Grid: ' \
                "cells=#{@cell_spaces.length}, states=#{@states.length}, transitions=#{@transitions.length}"
              )
              true
            end
        ...
        def finish_editing
          ...
          with_guard_flag(:@finishing_editing) do
            ...
            if finished
              ...
              finalize_local_grid_runtime_after_edit_finish
            end
            finished
          end
        end
        ...
        def finalize_local_grid_runtime_after_edit_finish
          if local_grid_runtime_refresh_required_after_edit_finish?
            soft_refresh_runtime_data_local_grid
        ...
        def local_grid_runtime_refresh_required_after_edit_finish?
