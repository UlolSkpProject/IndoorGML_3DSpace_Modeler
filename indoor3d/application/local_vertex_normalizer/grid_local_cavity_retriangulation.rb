  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:repair_grid_invalid_near_edge_splits_before_local_cavity)
          alias_method :repair_grid_invalid_near_edge_splits_before_local_cavity,
        ...
        def repair_grid_invalid_near_edge_splits(triangle_records)
          ...
          repaired, near_report =
            repair_grid_invalid_near_edge_splits_before_local_cavity(
              cavity_repaired
            )
