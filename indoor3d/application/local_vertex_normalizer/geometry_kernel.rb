  ...
  module Indoor3DGmlModeler
    module IndoorCore
      ...
      class LocalVertexNormalizer
        ...
        # commit_on_failure is an inspection aid. It preserves
        ...
        def with_normalization_operation(entity, commit_on_failure: false)
          ...
          begin
            operation_started = measure_diagnostic_stage(:operation_start) do
            ...
            committed = measure_diagnostic_stage(:operation_commit) do
            ...
            rollback_error = if operation_started
                               measure_diagnostic_stage(:operation_rollback) do
          ...
          entities.grep(@face_class).flat_map do |face|
            ...
            if face.respond_to?(:loops)
              begin
                ...
                # Some previously created SketchUp Faces contain numerically invalid loops
