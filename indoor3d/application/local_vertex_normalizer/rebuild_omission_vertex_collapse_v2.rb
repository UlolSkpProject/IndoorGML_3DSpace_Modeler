  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:rebuild_triangles_from_mesh_before_omission_vertex_collapse_v2)
          alias_method :rebuild_triangles_from_mesh_before_omission_vertex_collapse_v2,
        ...
        def rebuild_triangles_from_mesh(entities, triangles)
          rebuild_triangles_from_mesh_before_omission_vertex_collapse_v2(
            entities,
            triangles
          )
          ...
          repair_rebuild_omission_by_vertex_collapse_v2(
            entities,
            triangles,
            original_error
          )
        ...
        def repair_rebuild_omission_by_vertex_collapse_v2(
          entities,
          triangles,
          original_error
        )
          ...
          MAX_REBUILD_OMISSION_VERTEX_COLLAPSES.times do |iteration|
            ...
            begin
              ...
              @rebuild_omission_vertex_collapse_report_v2 = aggregate
              @rebuild_omission_vertex_collapse_mesh_validation_v2 = final_mesh_validation
        ...
        def rebuild_omission_vertex_collapse_candidate(entities, records, entry)
          ...
          candidate = records.map do |source_record|
            ...
            changed ? source_record.merge(
              points: points,
              rebuild_omission_vertex_collapse_v2: true
            ) : source_record
          end
        ...
        unless private_method_defined?(:build_normalization_report_before_omission_vertex_collapse_v2)
          alias_method :build_normalization_report_before_omission_vertex_collapse_v2,
                       :build_normalization_report
        end

        def build_normalization_report(*args, **kwargs)
          repair = @rebuild_omission_vertex_collapse_report_v2
          validation = @rebuild_omission_vertex_collapse_mesh_validation_v2
          kwargs = kwargs.merge(mesh_validation: validation) if repair && validation

          report = build_normalization_report_before_omission_vertex_collapse_v2(*args, **kwargs)
