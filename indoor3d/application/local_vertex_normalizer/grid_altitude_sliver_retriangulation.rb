  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:normalize_triangle_records_before_grid_altitude_sliver)
          alias_method :normalize_triangle_records_before_grid_altitude_sliver,
        ...
        def normalize_triangle_records_allowing_collisions(
          ...
          snapped, report = normalize_triangle_records_before_grid_altitude_sliver(
            records,
            axis_plane_plan,
          ...
          @grid_altitude_sliver_retriangulation_stats = repair_report
          [repaired, report]
        end
