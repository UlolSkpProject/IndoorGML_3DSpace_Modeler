...
module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      ...
      # rollback baseline for final_coplanar_face_merge_v2. The handoff is valid
      ...
      module LocalVertexNormalizerFinalCoplanarBaselineHandoffV2
        HANDOFF_ROLES = [
        ...
        def normalize_entity(entity)
          previous_context = @final_coplanar_baseline_handoff_context_v2
          context = {
            token: Object.new,
            entity: entity,
          ...
          @final_coplanar_baseline_handoff_context_v2 = context

          report = super
          attach_final_coplanar_baseline_handoff_report_v2(report, context)
          report
        ensure
          @final_coplanar_baseline_handoff_context_v2 = previous_context
        end
        ...
        def final_normalized_mesh_state(
          ...
          result = super
          context = @final_coplanar_baseline_handoff_context_v2
          ...
          capture_final_coplanar_baseline_handoff_v2(
            context,
            context[:entity],
            entities,
            result[0],
        ...
        def snapshot_final_coplanar_baseline(entities)
          ...
          validation = validate_final_coplanar_baseline_handoff_v2(
            context,
            handoff,
            entities
          )
        ...
        def capture_final_coplanar_baseline_handoff_v2(
          context,
          entity,
          entities,
          triangles,
          ...
          return false unless context.equal?(
            @final_coplanar_baseline_handoff_context_v2
          )
          ...
          return false if residual_mm > final_coplanar_grid_epsilon_mm_v2
        ...
        def validate_final_coplanar_baseline_handoff_v2(
          context,
          handoff,
          entities
        )
          ...
          elsif candidate_residual > final_coplanar_grid_epsilon_mm_v2
          ...
          elsif current_residual > final_coplanar_grid_epsilon_mm_v2
        ...
        def final_coplanar_grid_epsilon_mm_v2
      ...
      class LocalVertexNormalizer
        prepend LocalVertexNormalizerFinalCoplanarBaselineHandoffV2 unless
          ancestors.include?(
            LocalVertexNormalizerFinalCoplanarBaselineHandoffV2
          )
      end
    end
  end
