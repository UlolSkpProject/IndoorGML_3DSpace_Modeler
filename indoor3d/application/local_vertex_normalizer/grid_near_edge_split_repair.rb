  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:retriangulate_grid_invalid_source_faces_before_near_edge_split)
          alias_method :retriangulate_grid_invalid_source_faces_before_near_edge_split,
        ...
        def retriangulate_grid_invalid_source_faces(triangle_records)
          ...
          combined_report = source_report.merge(
            ...
            # Compatibility with grid_altitude_sliver_retriangulation: its
