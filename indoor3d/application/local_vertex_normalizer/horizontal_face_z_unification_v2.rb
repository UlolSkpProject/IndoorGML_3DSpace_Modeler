  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:normalize_entity_before_horizontal_face_z_unification_v2)
          alias_method :normalize_entity_before_horizontal_face_z_unification_v2,
                       :normalize_entity
        end

        # Experimental final-surface repair, intentionally placed immediately
        # before final_coplanar_face_merge_v2 in the alias load chain.
        #
        ...
        def normalize_entity(entity)
          report = normalize_entity_before_horizontal_face_z_unification_v2(entity)
