...
require_relative 'axis_and_triangle_policy'
require_relative 'rebuild_repair'
require_relative 'report'

module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      # Normalization pipeline overrides for LocalVertexNormalizer.
      class LocalVertexNormalizer
        ...
        def normalized?(entity)
          ...
          return false unless CoplanarCollinearEdgePolicy.fan_transition_vertices(
            entities,
        ...
        def normalize_entity(entity)
          ...
          source_boundary_normalization =
            (@source_boundary_normalization_stats || {}).dup
