  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:repair_grid_invalid_near_edge_splits_before_owner_flip)
          alias_method :repair_grid_invalid_near_edge_splits_before_owner_flip,
        ...
        def repair_grid_invalid_near_edge_splits(triangle_records)
          ...
          repaired, split_report =
            repair_grid_invalid_near_edge_splits_before_owner_flip(flipped)
