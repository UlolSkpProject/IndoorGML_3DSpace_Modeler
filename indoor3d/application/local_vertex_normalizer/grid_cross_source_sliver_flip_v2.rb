  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:repair_grid_invalid_near_edge_splits_before_cross_source_sliver_v2)
          alias_method :repair_grid_invalid_near_edge_splits_before_cross_source_sliver_v2,
        ...
        def repair_grid_invalid_near_edge_splits(triangle_records)
          base_repaired, base_report =
            repair_grid_invalid_near_edge_splits_before_cross_source_sliver_v2(
              triangle_records
            )
