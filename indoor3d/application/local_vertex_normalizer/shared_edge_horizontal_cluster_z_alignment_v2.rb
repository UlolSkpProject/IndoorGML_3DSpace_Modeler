  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:normalize_entity_before_shared_edge_horizontal_cluster_z_alignment_v2)
          alias_method :normalize_entity_before_shared_edge_horizontal_cluster_z_alignment_v2,
                       :normalize_entity
        end
        ...
        # that final_coplanar_face_merge_v2 should receive.
        #
        ...
        def normalize_entity(entity)
          report = normalize_entity_before_shared_edge_horizontal_cluster_z_alignment_v2(
            entity
          )
