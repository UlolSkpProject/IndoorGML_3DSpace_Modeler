...
module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      ...
      module LocalVertexNormalizerCoplanarSharedEdgeIntersectionFastPathV2
        private

        def normalize_entity(entity)
          previous_stats = @local_vertex_normalizer_coplanar_shared_edge_fast_path_stats_v2
          @local_vertex_normalizer_coplanar_shared_edge_fast_path_stats_v2 = {
            coplanar_calls: 0,
            shared_edge_calls: 0,
            fast_decisions: 0,
            fast_allowed: 0,
          ...
          stats = @local_vertex_normalizer_coplanar_shared_edge_fast_path_stats_v2
          emit_coplanar_shared_edge_intersection_fast_path_v2(stats) if stats
          @local_vertex_normalizer_coplanar_shared_edge_fast_path_stats_v2 = previous_stats
        end
        ...
        def coplanar_triangle_intersection_allowed?(triangle_a, triangle_b, shared)
          ...
          decision = coplanar_shared_edge_intersection_decision_v2(
            triangle_a,
            triangle_b,
            shared
          )
          ...
          coplanar_shared_edge_intersection_fallback_v2(stats, error)
          super
        end

        def coplanar_shared_edge_intersection_decision_v2(triangle_a, triangle_b, shared)
        ...
        def coplanar_shared_edge_intersection_fallback_v2(stats, error)
          return unless stats
        ...
        def emit_coplanar_shared_edge_intersection_fast_path_v2(stats)
      ...
      class LocalVertexNormalizer
        prepend LocalVertexNormalizerCoplanarSharedEdgeIntersectionFastPathV2 unless
          ancestors.include?(LocalVertexNormalizerCoplanarSharedEdgeIntersectionFastPathV2)
      end
    end
  end
end
