...
require_relative 'coplanar_face_component_merge_v2'
    ...
    module IndoorCore
      class LocalVertexNormalizer
        FINAL_COPLANAR_FACE_PLANE_TOLERANCE_MM =
          CoplanarFaceComponentMergeV2::DEFAULT_PLANE_TOLERANCE_MM unless
            const_defined?(:FINAL_COPLANAR_FACE_PLANE_TOLERANCE_MM, false)
        FINAL_COPLANAR_FACE_ANGLE_TOLERANCE_DEG =
          CoplanarFaceComponentMergeV2::DEFAULT_ANGLE_TOLERANCE_DEG unless
        ...
        # standalone dev experiment. The geometry decision and acceptance gates
        # live only in CoplanarFaceComponentMergeV2.
        #
        ...
        def normalize_entity(entity)
          ...
          begin
            merge_report = CoplanarFaceComponentMergeV2.merge!(
              entity,
