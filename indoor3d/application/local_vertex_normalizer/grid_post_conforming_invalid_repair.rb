  ...
  module Indoor3DGmlModeler
    module IndoorCore
      class LocalVertexNormalizer
        ...
        unless private_method_defined?(:collapse_short_edge_sliver_triangles_before_post_conforming_invalid_repair)
          alias_method :collapse_short_edge_sliver_triangles_before_post_conforming_invalid_repair,
        ...
        def collapse_short_edge_sliver_triangles(
          ...
          collapsed, sliver_report =
            collapse_short_edge_sliver_triangles_before_post_conforming_invalid_repair(
              triangle_records,
              plan,
              baseline_validation
            )
          ...
          @grid_post_conforming_invalid_repair_stats = repair_report
