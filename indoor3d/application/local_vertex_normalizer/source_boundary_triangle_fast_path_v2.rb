...
module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      ...
      # polygon triangulation that the legacy source-boundary path would build.
      #
      ...
      module LocalVertexNormalizerSourceBoundaryTriangleFastPathV2
        private
      ...
      class LocalVertexNormalizer
        prepend LocalVertexNormalizerSourceBoundaryTriangleFastPathV2 unless
          ancestors.include?(
            LocalVertexNormalizerSourceBoundaryTriangleFastPathV2
          )
      end
    end
  end
