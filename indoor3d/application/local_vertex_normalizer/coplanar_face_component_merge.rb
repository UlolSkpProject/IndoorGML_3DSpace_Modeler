...
module ULOL
  module Indoor3DGmlModeler
    module IndoorCore
      ...
      # - the standalone coplanar-face merge diagnostic runner
      ...
      module CoplanarFaceComponentMerge
        MM_PER_INCH = 25.4
        ...
        def merge!(solid, angle_tolerance_deg: DEFAULT_ANGLE_TOLERANCE_DEG,
          ...
          plans.each do |plan|
            protection =
              CoplanarCollinearEdgePolicy.protected_fan_transition_edges(
                faces: plan[:faces],
        ...
        def prepare_ring_self_touch_repair(plans)
          bundles = Array(plans).flat_map do |plan|
            CoplanarCollinearEdgePolicy.ring_self_touch_repair_edge_bundles(
              faces: plan[:faces],
              internal_edges: plan[:internal_edges]
            )
          end
