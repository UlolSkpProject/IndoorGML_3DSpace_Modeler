...
# v2 normalization pipeline, then grid-space repair/runtime regression layers.
# Provenance diagnostics describe failed patch rebuilds, and the final profiler
# layer remains dormant unless debug or report timing is requested.
